<template>
    <div class="card">
      ...
      <a :href="image.slug" class="d-flex flex-column justify-content-between p-2 overflow-hidden card-thumbnail">
        ...
        <a :href="image.slug" class="username">
...
export default {
  ...
  data(){
    return {
      "image" : {
        "name" : "",
        "preview" : "https://imgs.wallone.ru/b7H5gKG/ad.png",
        "type" : "IMG",
        "slug": "",
        "fields": {
          "popular" : true,
      ...
      "user" : {
        "avatar" : "https://imgs.wallone.ru/users/70063fa618c44681b158504e06820a9c.jpg",
        "username" : "Partner",
        "verify" : true
      }
    }
